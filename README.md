...
> AI Researcher & Algorithm Engineer — working at the intersection of computer vision, deep learning, and large language model systems.

- 🔭 **Currently building:** production-ready AI applications powered by LLM Agents & RAG
- 🧠 **Focused on:** Computer Vision, Large Language Models, Deep Learning, RAG, AI Agent & Multi-Agent Systems, Backend Engineering
...
| 🏥 Medical Multi-Agent System | 🎓 Learning Multi-Agent System |
| :--- | :--- |
| AI-powered clinical decision support system | Research project exploring agent architectures |
| • Medical RAG<br>• Multi-Agent Reasoning<br>• Knowledge Retrieval<br>• LLM Clinical Analysis | • Agent Collaboration<br>• Memory Architecture<br>• Tool Calling<br>• Workflow Orchestration |
